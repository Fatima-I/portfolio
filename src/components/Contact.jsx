    ...
    <section id="contact" style={{ padding: '7rem 0', borderTop: '1px solid rgba(255,255,255,0.04)', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: 700, margin: '0 auto', padding: '0 2rem', textAlign: 'center', position: 'relative' }}>
        <FadeIn>
          ...
          <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '1rem', color: '#8892A0', lineHeight: 1.85, marginBottom: '3rem', maxWidth: 500, margin: '0 auto 3rem' }}>
        ...
        <FadeIn delay={0.15}>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem' }}>
            <motion.a href={`https://mail.google.com/mail/?view=cm&to=${personal.email}`}
            ...
            <div style={{ display: 'flex', gap: '1.5rem' }}>
              {[
                ...
                <a key={label} href={href} target="_blank" rel="noreferrer"
                  style={{ display: 'flex', alignItems: 'center', gap: 7, fontFamily: "'Inter', sans-serif", fontSize: 14, color: '#8892A0', textDecoration: 'none', transition: 'color 0.2s' }}
